    ...
    <div className="min-h-screen flex flex-col">
      ...
      <header 
        className={`fixed w-full z-50 transition-all duration-300 ${
          isScrolled ? 'bg-white/90 dark:bg-dark/90 backdrop-blur-sm shadow-md' : 'bg-transparent'
        }`}
      >
        <div className="container mx-auto px-4 py-4">
          ...
          {mobileMenuOpen && (
            ...
            >
              ...
              <a
                href="https://github.com/yourusername/tank-helper"
                target="_blank"
                rel="noopener noreferrer"
                className="block btn w-full text-center"
              >
                GitHub
              </a>
            </motion.div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              ...
              <p className="mt-2 text-gray-400">Enhance your World of Tanks experience</p>
            </div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400 text-sm">
            <p>© {new Date().getFullYear()} WOTBot. All rights reserved.</p>
            <p className="mt-2">Not affiliated with Wargaming.net or World of Tanks.</p>
          </div>
        </div>
      </footer>
    </div>
